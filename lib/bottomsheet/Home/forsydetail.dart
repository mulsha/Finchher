import 'package:fincherr/bottomsheet/Home/forsyhand.dart';
...
class fdetails extends StatefulWidget {
  ...
  fdetails(this.img, this.price, this.name, this.eth, this.index);

  @override
  State<fdetails> createState() => _fdetailsState();
}
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          ...
                          Container(
                            child: Text(widget.eth[widget.index],
                                style: TextStyle(
                                    fontSize: 17,
            ...
            child: Container(
              ...
              child: GridView.builder(
                ...
                gridDelegate: SliverGridDelegateWithMaxCrossAxisExtent(
                    maxCrossAxisExtent: th * 0.5, mainAxisExtent: th * 0.2),
